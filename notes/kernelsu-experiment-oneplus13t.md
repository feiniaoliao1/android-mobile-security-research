...
## Experiment Overview
Study KernelSU LKM root, root detection, SELinux mode, and root hiding theory.

## Environment
- Device: OnePlus 13T
- Root solution: KernelSU (LKM)
- Test tools: su, top, dmesg, LSPosed

## Key Operation
1. Patch boot.img and flash KernelSU into boot partition.
